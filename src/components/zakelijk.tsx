      ...
      <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
        <div>
          ...
          <h2 className="font-display mt-3 text-3xl font-semibold tracking-tight sm:text-4xl">
            Partnerschappen voor showrooms en fleets
          </h2>
          <p className="mt-4 max-w-xl text-base leading-relaxed text-muted">
            Naast particulieren werken wij samen met bedrijven die hun
            voertuigen, of die van hun klanten, professioneel willen laten
            verzorgen. Flexibel op locatie, met een vaste werkwijze.
          </p>
